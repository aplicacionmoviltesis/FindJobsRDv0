...
public class cPantallaRegistrarCurriculo extends AppCompatActivity {
    ...
    String nombre, apellido, cedula, email, telefono, celular, provincia, estadoCivil, direccion, ocupacion,
            idioma, gradomayor, estadoactual, sexo, habilidades, fecha, area;
   ...
   /* public void CargarCurriculoActualizar(String userActivo) {
        databaseReferenceCurriloAct.orderByChild( "cIdBuscador" ).equalTo( userActivo ).addValueEventListener( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                etOcupacion.setText( curriculos.getsEmailC() );
                mEtxtIdioma.setText( curriculos.getsTelefonoC() );
                mEtxtFecha.setText( curriculos.getsCelularC() );
                etHabilidades.setText( curriculos.getsDireccionC() );
...
//--------------------------------------cargar curriculo--------------------------------------------------------------------------------------
    ...
    private void CargarCamposCurriculo(String userActivo) {
        ...
        Query q = bbdd.orderByChild("sIdBuscadorEmpleo").equalTo(userActivo);
...
*/
                for (DataSnapshot datasnapshot : dataSnapshot.getChildren()) {
                   ...
                   // com.example.findjobsrdv0.Modelos_CurriculoCompleto.Curriculos curriculos = dataSnapshot.getValue(com.example.findjobsrdv0.Modelos_CurriculoCompleto.Curriculos.class);

                   // Log.d("holaaaa", String.valueOf(curriculos.getsNombreC()));
...
*/
                    ...
                    Picasso.get().load( curriculos.getsImagenC() ).into( imageViewcurriculo );
