...
public class PantallaListaCurriculosBuscados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        provinciasRefCurriculo.child("provincias").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> provinciasAdapterCurriculo = new ArrayAdapter<String>(PantallaListaCurriculosBuscados.this, android.R.layout.simple_spinner_item, ListProvinciasCurri);
            ...
            protected void populateViewHolder(VistaCurriculoViewHolder viewHolder, Curriculos model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent CurriculoDetalle = new Intent(PantallaListaCurriculosBuscados.this, DetalleCurriculo.class);
