...
public class ViewHolderCompCurriculo extends RecyclerView.Adapter<ViewHolderCompCurriculo.MultiViewHolder> {
    ...
    public ArrayList<modeloCompararCurriculo> curriculoFavs;
    private ViewGroup viewGroup;

    public ViewHolderCompCurriculo(Context context, ArrayList<modeloCompararCurriculo> curriculoFavs) {
        this.context = context;
        this.curriculoFavs = curriculoFavs;
    }

    public void setCurriculoFavs(ArrayList<modeloCompararCurriculo> curriculoFavs) {
    ...
    public class MultiViewHolder extends RecyclerView.ViewHolder {
        ...
        public MultiViewHolder(@NonNull View itemView) {
         ...
         void bind(final modeloCompararCurriculo curriculoFavs) {
    ...
    public ArrayList<modeloCompararCurriculo> getSelected() {
        ArrayList<modeloCompararCurriculo> selected = new ArrayList<>();
